 ...
 class TweetPHP {
    ...
    public function  __construct ($options = array()) {
      ...
      array(
          ...
          //'cachetime'             => 1, // Seconds to cache feed (1 hour).
          ...
          'twitter_wrap_open'     => '<h4 class="tw">Tapestry on Twitter</h4>',
          'twitter_wrap_close'    => '',
          'tweet_wrap_open'       => '<p>',
    ...
    private function parse_tweet ($tweet) {
      ...
      //return $this->options['tweet_wrap_open'] . $tweet_text . $this->options['meta_wrap_open'] . '<br/><a href="' . $href . '">' . $display_time . '</a>' . $this->options['meta_wrap_close'] . $this->options['tweet_wrap_close'];
      // Removed the date from original output
      return $this->options['tweet_wrap_open'] . $tweet_text . $this->options['meta_wrap_open'] . $this->options['meta_wrap_close'] . $this->options['tweet_wrap_close'];
    }
